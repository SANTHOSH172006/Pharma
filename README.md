...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <a class="navbar-brand" href="#">PHARMA MEDICS</a>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        <h1>WELCOME TO PHARMA MEDICS</h1>
         <p>Welcome pharma medics, where every visit is a gathering of care and compassion. Step into our welcoming embrace, where expert guidance meets personalized attention. Your journey to better health starts here, amidst warmth and genuine concern. Welcome home, to Pharma medic, where your well-being is our top priority.</p>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; copyright @ 2024 Made and Developed by SANTHOSH D (212223220099)
    </p>
  </footer>
 ...
 <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany - SANTHOSH D (212223220099) All rights reserved.</p>
  </footer>
...
<body>
  ...
  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany - SANTHOSH D (21222322009) All rights reserved.</p>
  </footer>
...
<body>
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <a class="navbar-brand" href="#">AI MEDICS</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
  ...
  <div class="container mt-8">
    <div class="row">
      <div class="col-md-11">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="p3.jpg" class="card-img-top" alt="Product 1">
            <div class="card-body">
          ...
          <div class="card">
            <img src="p1.jpg" class="card-img-top" alt="Product 3">
            <div class="card-body">
...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          vellore fort,nagar street,vellore.<br>
          <br>
          <strong>Email:</strong><br>
          pharmamedics@gmail.com<br><br>
  ...
  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany - SANTHOSH D All rights reserved.</p>
  </footer>
...
![alt text](<san/ludus/static/Screenshot 2024-05-13 171335.png>)
